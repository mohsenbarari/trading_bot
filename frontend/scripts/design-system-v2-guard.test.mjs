    ...
    const approvedSources = [
      ...
      },
      {
        ...
        source: [
          ...
          '<header class="dashboard-header"><div class="dashboard-header-main"><button class="user-info-center" /><button class="notif-btn" /></div><h1 class="dashboard-page-title">خانه</h1></header>',
          '<div class="dashboard-notice" />',
          '</div>',
          '<section class="main-section"><MarketHero />',
          '<AppDesignSystemScope class="ui-v2-pwa-section"><PWAInstallOverlay /></AppDesignSystemScope></section>',
          '</template>',
        ].join('\n'),
      },
      {
