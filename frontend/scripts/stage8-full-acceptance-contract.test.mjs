...
describe('Stage 8 descriptor contract is fail-closed', () => {
  ...
  it('binds the descriptor module into the official hash set', () => {
    ...
    expect(browserSource).toMatch(/releaseHeldRequest/)
    expect(browserSource).toMatch(/holdEndpoint/)
    expect(runtimeSource).toMatch(/releaseHeldRequest/)
    expect(runtimeSource).toMatch(/shouldHoldLoadingPath/)
