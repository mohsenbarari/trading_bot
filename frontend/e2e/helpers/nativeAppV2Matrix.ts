...
export const ROUTE_DESCRIPTORS: RouteDescriptor[] = [
  ...
  },
  {
    ...
    h1: 'مشتری پذیرش',
    ctaRequired: false,
    holdPath: '/api/customers/owner-relations/13',
    errorPath: '/api/customers/owner-relations/13',
    errorText: /ناموفق|خطا|دوباره|دریافت/i,
    loadingText: /در حال|بارگذاری/i,
    scroller: { kind: 'standard', expected: 1 },
  ...
  },
  {
    ...
    h1: 'حسابدار پذیرش',
    ctaRequired: false,
    holdPath: '/api/accountants/owner-relations/13',
    errorPath: '/api/accountants/owner-relations/13',
    errorText: /ناموفق|خطا|دوباره|دریافت/i,
    loadingText: /در حال|بارگذاری/i,
    scroller: { kind: 'standard', expected: 1 },
    states: listStates({ unauthorized: true, stale: false, empty: false }),
