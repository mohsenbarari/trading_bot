...
function getSafeRelationConfirmationError(action: 'cancel-invitation' | 'close-relation') {
...
<template>
  <div class="ds-page customer-workspace-view">
    ...
    >
      <template #actions>
        <AppButton variant="ghost" class="customer-workspace-create" @click="openCreatePanel">
          <template #icon>
            <UserPlus :size="16" />
          </template>
          افزودن مشتری
