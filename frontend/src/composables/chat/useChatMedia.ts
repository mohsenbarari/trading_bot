...
export function useChatMedia(options: UseChatMediaOptions) {
    ...
    return {
        ...
        __testHooks: {
            ...
            isEditedImageUploadFile,
            normalizeImageUploadFile,
            nativeImageCompress,
            createOptimisticUploadId,
            getScaledDimensions,
            dataUrlFromBlob: blobToDataUrl,
            appendAlbumMetadata,
            appendCaptionMetadata,
            getAlbumIdFromMessage,
            getMediaClientCapability,
            getAdaptiveHydrationLimit,
            getAdaptivePreprocessLimit,
            getAdaptiveUploadLimit,
            runAdaptivePreprocessTask,
            runAdaptiveUploadTask,
            cancelDocumentDownload,
            cancelMediaDownload,
            setCachedMediaUrl,
            buildMediaLoadKey,
            ...
            getAlbumIndexFromMessage,
            getAlbumMessages,
            buildLightboxMediaItem,
            preprocessVideoPreview,
            state: {
                imageCache,
                messages,
                pendingMediaLoads,
                pendingHydrationKeys,
                hydrationQueue,
                preprocessQueue,
                networkUploadQueue,
            },
