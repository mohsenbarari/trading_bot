            ...
            payloads.append(
                {
                    ...
                    "responder_kind": base["responder_kind"],
                    "group_relation": base["group_relation"],
                    "offer_surface": base["offer_surface"],
                    "request_surface": base["request_surface"],
                    "surface_pair": base["surface_pair"],
                    "quadrant": base["quadrant"],
                    "outage_id": base["outage_id"],
                    "offer_home_server": base["offer_home_server"],
                    "request_source_server": base["request_source_server"],
                    "expected_remote_delivery_policy": base["expected_remote_delivery_policy"],
                    "offer_type": base["offer_type"],
                    "shape": base["shape"],
                    "policy_supported": True,
                    "expected_outcome": "stress_completed",
