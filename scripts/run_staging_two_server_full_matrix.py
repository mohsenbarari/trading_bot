...
DRIVER_SCENARIOS = [
    ...
    {
        "id": "DRIVER-BOT-RETAIL-THREE-LOT-MIXED-BUY",
        "offer_origin": "bot",
        "offer_type": "buy",
        "retail": True,
        "lot_sizes": "10,10,10",
        "hot_offer_quantity": 30,
        "request_amount": 10,
        "expected_winner_count": 3,
        "expected_remaining_quantity": 0,
        "request_surface": "mixed",
        "telegram_ratio": 0.5,
        "hot_offer_requests": 18,
        "target_rps": 4.0,
        "idempotency_mode": "unique",
        "coverage": ["retail_three_lot", "same_lot_contention", "mixed_surface_requests", "foreign_home_offer"],
        "manifest_cells": [
    ...
    {
        "id": "DRIVER-WEBAPP-RETAIL-THREE-LOT-MIXED-SELL",
        "offer_origin": "webapp",
        "offer_type": "sell",
        "retail": True,
        "lot_sizes": "10,10,10",
        ...
        "target_rps": 4.0,
        "idempotency_mode": "unique",
        "coverage": ["retail_three_lot", "same_lot_contention", "mixed_surface_requests", "iran_home_offer"],
        "manifest_cells": [
            "market:shape:retail_three_lot",
            "market:terminal:completed",
            "market:request_surface:balanced",
    ...
    {
        # Wholesale is all-or-nothing; remaining>0 partial is proven via retail lot fill.
        "id": "DRIVER-WEBAPP-RETAIL-PARTIAL-SELL",
        "offer_origin": "webapp",
        "offer_type": "sell",
        "retail": True,
        "lot_sizes": "10,10",
        ...
        # Single request fills exactly one retail lot; remaining stays 10.
        ...
        "coverage": ["retail_partial", "remaining_quantity", "iran_home_offer"],
        "manifest_cells": [
    ...
    },
    {
        ...
        "coverage": ["idempotency_no_duplicate_trade", "foreign_home_offer", "mixed_surface_replay"],
        "manifest_cells": [
            "market:authority:foreign_iran",
            "market:request_surface:balanced",
            "market:terminal:completed",
    ...
    },
    {
        ...
        "manifest_cells": ["market:authority:iran_iran", "market:request_surface:balanced"],
    },
    {
...
# Negative-guard cases run by the combined matrix for rejected / tier actors.
NEGATIVE_GUARD_CASES = (
    {
        "id": "GUARD-TIER2-OFFER-CREATE",
        "case_id": "tier2_offer_creation",
        "manifest_cells": ["market:actor:tier2_customer", "market:terminal:rejected"],
    },
    {
        "id": "GUARD-TIER2-TELEGRAM-REQUEST",
        "case_id": "tier2_telegram_request",
        "manifest_cells": ["market:actor:tier2_customer", "market:terminal:rejected"],
    },
    {
        "id": "GUARD-INVALID-REQUEST-AMOUNT",
        "case_id": "invalid_request_amount",
        "manifest_cells": ["market:terminal:rejected", "market:actor:tier1_customer"],
    },
)
