...
if not re.fullmatch(r'/tmp/stage3-[0-9a-f]{8}-[0-9a-f]{8}-transfer/(three-site-stage3-[0-9a-f]{8}\.bundle|trading-bot-postgres-boottime-[0-9a-f]{8}\.tar\.zst)',destination): raise RuntimeError('artifact destination is outside approved transfer root')
