...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--iran-host", default=os.getenv("IRAN_HOST", "root@87.107.110.68"), help="Iran SSH target.")
    parser.add_argument("--iran-dir", default=os.getenv("IRAN_DIR", "/root/trading-bot/trading_bot"), help="Iran repo directory.")
