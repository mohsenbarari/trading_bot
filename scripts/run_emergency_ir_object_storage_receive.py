...
def bundle_ready(target):
 ...
 allowed={"run_receiver.py","signing-public.key","scripts/__init__.py","scripts/emergency_ir_object_storage_manifest.py","scripts/emergency_ir_object_storage_receiver.py","scripts/emergency_ir_standalone_activate.py"}
