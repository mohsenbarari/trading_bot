    ...
    *,
    ...
    if schema == PREPARED_SCHEMA:
        ...
        files = {
            ...
            SESSION_NAME: (session_bytes, FINAL_FILE_MODES[SESSION_NAME]),
            POLICY_NAME: (policy_bytes, FINAL_FILE_MODES[POLICY_NAME]),
            PREPARED_MANIFEST_NAME: (
                prepared_manifest_bytes,
