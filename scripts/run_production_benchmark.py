...
def build_tasks(
    *,
    ...
    tasks = [
        ...
        BenchmarkTask(
            task_id="observability_readiness",
            surface_id="B10",
            label="Stage P9 observability, audit-anchor, sync sampler, metrics, and artifact hygiene readiness benchmark",
            profile="observability",
            command=[
                sys.executable,
                "scripts/report_observability_readiness.py",
                *manifest_args,
                "--timestamp",
                stamp,
                "--artifact-root",
            ...
            timeout_seconds=420,
            bottleneck_class="observability_readiness",
            modes=("targeted", "full"),
        ),
        BenchmarkTask(
        ...
        BenchmarkTask(
            task_id="deployment_restart_benchmark",
            surface_id="B11",
            label="Stage P10 production release, backup, restart, and rollback benchmark",
            profile="deployment",
            command=[
                sys.executable,
                "scripts/report_deployment_restart_benchmark.py",
                *manifest_args,
                "--timestamp",
                stamp,
                "--artifact-root",
            ...
            bottleneck_class="deployment_restart_rollback",
            modes=("targeted", "full"),
        ),
        BenchmarkTask(
