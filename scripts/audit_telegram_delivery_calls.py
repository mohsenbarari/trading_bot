...
PRE_SPLIT_TELEGRAM_RUNTIME_INVENTORY_SHA256 = (
...
REVIEWED_RUNTIME_INVENTORY_SHA256 = frozenset(
    {
        ...
        PRE_STAGE8_EDGE_CALLBACK_WITNESS_RUNTIME_INVENTORY_SHA256,
        # The split runtime changes queue ownership and gateway transport
        # lifecycle without accepting an unreviewed Telegram callsite.
        PRE_SPLIT_TELEGRAM_RUNTIME_INVENTORY_SHA256,
