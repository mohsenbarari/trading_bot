...
SCRATCH_DATABASE_PATTERN = re.compile(
    r"^(?:stage1_migration|stage1_counter|stage2_registration|stage3_registration|stage4_registration|market_stage7|market_stage9|market_stage10|market_stage11|market_stage12)_[a-z0-9_]+$"
)
