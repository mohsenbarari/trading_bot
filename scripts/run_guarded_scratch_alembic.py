...
SCRATCH_DATABASE_PATTERN = re.compile(
    r"^(?:stage1_migration|stage1_counter|stage2_registration|stage3_registration|stage4_registration|market_stage7|market_stage8|market_stage9|market_stage10|market_stage11|market_stage12|market_stage13|market_stage15|telegram_queue_stage3|coin_intelligence)_[a-z0-9_]+$"
)
