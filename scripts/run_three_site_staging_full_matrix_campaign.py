...
def main(argv: list[str] | None = None) -> int:
    # Even ``verify`` writes a caller-selected report path. The entire retired
    # CLI must stop before parsing caller-provided paths or opening artifacts.
    try:
        assert_retired(component="staging-full-matrix-campaign", operation="CLI")
