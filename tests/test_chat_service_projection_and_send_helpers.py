...
class ChatServiceProjectionAndSendHelperTests(unittest.IsolatedAsyncioTestCase):
    async def test_direct_conversation_projection_builders(self):
        ...
        self.assertIn("customer_relations", projection_sql)
        self.assertIn("management_name", projection_sql)
        ...
        self.assertIn("customer_relations", poll_sql)
        self.assertIn("management_name", poll_sql)
        self.assertIn("unread_count", poll_sql)
        self.assertIn("is_muted", poll_sql)
        self.assertIn("chats.type = 'DIRECT'", poll_sql)
