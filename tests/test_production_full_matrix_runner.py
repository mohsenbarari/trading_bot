...
class ProductionFullMatrixRunnerTests(unittest.TestCase):
    ...
    def test_execution_plan_builds_two_server_dual_role_commands_for_user_stable_case(self):
        ...
        self.assertIn("-p", commands_by_name["distribute_webapp_role_plan"]["args"])
        self.assertIn("37067", commands_by_name["distribute_webapp_role_plan"]["args"])
        self.assertTrue(any("test -f" in str(arg) for arg in commands_by_name["distribute_webapp_role_plan"]["args"]))
        self.assertIn("install_telegram_role_plan_in_foreign_container", command_names)
        self.assertIn("sync_prefix_catchup_from_offer_home_server", command_names)
        ...
        self.assertIn("install_telegram_role_result_in_offer_home_container", command_names)
