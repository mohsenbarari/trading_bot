...
class DeploySurfaceSmokeTests(unittest.TestCase):
    ...
    def test_staging_frontend_dist_isolated_from_production_artifact(self):
        ...
        self.assertIn('IRAN_SERVER_URL: ${STAGING_FOREIGN_IRAN_SERVER_URL:?STAGING_FOREIGN_IRAN_SERVER_URL is required}', staging_compose)
        self.assertIn('FRONTEND_URL: ${STAGING_FOREIGN_FRONTEND_URL:?STAGING_FOREIGN_FRONTEND_URL is required}', staging_compose)
