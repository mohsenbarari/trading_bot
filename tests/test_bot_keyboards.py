...
class BotKeyboardsTests(unittest.TestCase):
    def test_primary_menu_keyboards(self):
        ...
        self.assertFalse(super_admin_menu.is_persistent)
        ...
        self.assertFalse(standard_panel.is_persistent)
        ...
        self.assertFalse(user_panel.is_persistent)
    ...
    def test_admin_and_user_management_keyboards(self):
        ...
        self.assertFalse(admin_panel.is_persistent)
        ...
        self.assertFalse(users_management.is_persistent)
