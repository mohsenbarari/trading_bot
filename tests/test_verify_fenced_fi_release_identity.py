...
class VerifyFencedFiReleaseIdentityTests(TestCase):
    def _fixture(self, directory: Path) -> tuple[Path, Path]:
        ...
        unsigned: dict[str, object] = {
            "schema": "gold-trade-wa-fi-fenced-release-identity-v1",
            "release_sha": "a" * 40,
        ...
        signature = private.sign(
            b"gold-trade-wa-fi-fenced-release-identity-v1\x00" + canonical_json_bytes(unsigned)
        )
        ...
        _write_private(descriptor, canonical_json_bytes(document))
