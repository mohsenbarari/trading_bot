...
class BotWebAppIntegrationMatrixTests(unittest.TestCase):
    ...
    def test_matrix_preserves_step_11_required_scenario_contract(self):
        expected_titles = {
            ...
            "Owner expiry from Telegram bot records bot source while preserving the untraded channel post",
            ...
            "Telegram markers distinguish traded offers while untraded expiry preserves the post",
            "Telegram trade edits stay terminal while expiry and final-tail remain visual no-ops",
