...
class SyncFieldPolicyTests(unittest.TestCase):
    ...
    def test_required_sensitive_fields_have_explicit_classification(self):
        expectations = {
            ...
            ("telegram_admin_broadcasts", "content_kind"): SyncFieldClassification.SYNC,
            ("telegram_admin_broadcasts", "telegram_media_file_id"): SyncFieldClassification.SYNC,
            ("telegram_admin_broadcasts", "telegram_media_file_unique_id"): SyncFieldClassification.SYNC,
            ("telegram_admin_broadcasts", "media_duration_seconds"): SyncFieldClassification.SYNC,
