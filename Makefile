...
stage9-infrastructure-gate:
	@PYTHONPATH="$(CURDIR)/tmp/stage9-site-packages:$${PYTHONPATH}" python3 -m unittest tests.test_stage9_async_checkpoints tests.test_stage9_ci_contract tests.test_stage9_diff_coverage tests.test_stage9_mutation_contracts tests.test_stage9_mutation_runner tests.test_stage9_redis_runner tests.test_stage9_test_matrix tests.test_stage9_traceability tests.test_registration_identity_property tests.test_registration_scratch_suite
	@PYTHONPATH="$(CURDIR)/tmp/stage9-site-packages:$${PYTHONPATH}" python3 scripts/build_stage9_traceability.py --output tmp/stage9-traceability.json
