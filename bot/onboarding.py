...
فرمت کلی:
کالا + تعداد + فی + نوع معامله و تسویه + بخش‌های خُرد اختیاری + توضیحات اختیاری

مثال:
ربع 20تا 49000 ف 5 7 8 : فیش درشت

قواعد مهم:
• نقد حاضر: «خ» یا «خرید» برای خرید؛ «ف» یا «فروش» برای فروش.
• فردایی: «خ ف» یا «خ‌ف» یا «خف» برای خرید؛ «ف ف» یا «ف‌ف» یا «فف» برای فروش.
• جای بلوک نوع معامله و تسویه آزاد است، اما اجزای آن باید کنار هم و فقط یک بار نوشته شوند.
• نام کالا اختیاری است. اگر نام را ننویسید، سیستم آن را فقط از روی بازهٔ قیمت تشخیص می‌دهد یا از شما گزینه‌های نزدیک را می‌پرسد.
• «پ» اختیاری و فقط نشانهٔ تاریخ پایین است؛ برای نمونه «خ ربع پ 20تا 45800».
• تعداد باید با «تا» یا «عدد» بیاید؛ مثل 20تا یا 20 عدد.
• فی را کامل بنویسید یا دقیقاً سه صفر آخر را حذف کنید؛ مثلاً 197 یعنی 197000 و 59 یعنی 59000. عدد چهاررقمی کوتاه مثل 1876 معتبر نیست.
...
نمونه‌های صحیح:
خ ربع 20تا 49000
نیم 10 عدد فروش فردا 125000
ربع 20تا 49000 5 7 8 ف
امام 30تا 85000 خرید
