...
مثال:
ربع 20تا 49000 ف ن 5 7 8 : فیش درشت

قواعد مهم:
• نقد حاضر: «خ ن» یا «خرید نقد» برای خرید؛ «ف ن» یا «فروش نقد» برای فروش.
• فردایی: «خ ن ف» یا «خرید نقد فردا» برای خرید؛ «ف ن ف» یا «فروش نقد فردا» برای فروش.
• جای بلوک نوع معامله و تسویه آزاد است، اما اجزای آن باید کنار هم و فقط یک بار نوشته شوند.
• «خ» و «ف» به‌تنهایی معتبر نیستند.
...
نمونه‌های صحیح:
خ ن ربع 20تا 49000
نیم 10 عدد فروش نقد فردا 125000
ربع 20تا 49000 5 7 8 ف ن
امام 30تا 85000 خرید نقد
