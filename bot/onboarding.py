...
فرمت کلی:
نوع معامله و تسویه + کالا + تعداد + فی + بخش‌های خُرد اختیاری + توضیحات اختیاری

مثال:
ف ن ربع 20تا 49000 5 7 8 : فیش درشت
...
نمونه‌های صحیح:
خ ن ربع 20تا 49000
فروش نقد فردا نیم 10 عدد 125000
ف ن ربع 20تا 49000 5 7 8
خرید نقد امام 30تا 85000
