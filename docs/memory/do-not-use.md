...
- Do not restore retired Release0/WA-IR/FI/Writer-Witness/Object-Delta refs, checkpoints, or artifacts; they belonged to the obsolete three-site control plane, conflicted with current signed sync and multi-publisher Queue, and were fully removed.
