...
- 2026-08-18 | Market keeps 44px two-tap active cards, meter/hourglass, and compact distinct traded/expired history. Today trades are identity/private. Completed trades refresh Today/self-history via private events plus receipts and one five-second toast. Bot uses ☀️/📆 and hides customer route.
