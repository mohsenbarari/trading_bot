...
- 2026-08-20 | Integrity pass unified leftover non-Market chrome to 48px native rows/`AppInput`. V2 catalog tokens and test-locked 44px PublicProfile/UserManager stay. Live messenger stays on `native-app-messenger-visual-v1`.
