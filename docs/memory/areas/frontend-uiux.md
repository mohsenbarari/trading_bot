...
- 2026-08-19 | UIUX V3 profile: self/public/admin share ProfileIdentityHeader and section primitives; `/profile` and `/users/:id` reuse one workspace root; request ownership stays in PublicProfile/UserProfile.
