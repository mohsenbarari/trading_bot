...
- 2026-08-16 | Market/dashboard contract: compact Market cards retain the 44px two-tap, no-countdown meter, hourglass, distinct terminal states, normalized requests, and fail-closed protection. Outside the frozen hero, Home loads identity-bound paginated today trades, lazy privacy-aware coworker/commodity disclosures, and an account menu; customer/accountant invite actions stay in the scroll body so keyboards cannot pin them over fields.
