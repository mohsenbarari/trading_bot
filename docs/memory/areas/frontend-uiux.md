...
- 2026-08-14 | Stage 8 stays open: 270 expected / 0 full / 12 partial / 163 non-counting / `acceptanceAuthority=false`. Official local Gate A v3 is clean-worktree-only and source-bound; applicable cells pass locally and N/A stays source-derived. Prior v2 receipt `fb69a47b` stays non-promotable. After Stage 8 closes, Market continues from base A with decision/amount clarity from C. No push, staging, or owner acceptance yet.
