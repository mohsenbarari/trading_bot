...
- 2026-08-14 | Stage 8 stays open: 270 expected / 0 full / 12 partial / 163 non-counting / `acceptanceAuthority=false`. Gate A v3 passed on the pre-Market tree; Market A+C is now integrated locally so final acceptance must rerun on the merged source. Prior v2 receipt stays non-promotable; no push, staging, or owner acceptance yet.
