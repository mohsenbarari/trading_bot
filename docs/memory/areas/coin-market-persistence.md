...
- Market Facts use a durable private lane independent of product sync.
- Pipeline is Docker-native: one commit-bound image, isolated commands, local volumes, no baked state/secrets or network SQLite. Legacy stays for shadow/rollback until parity.
