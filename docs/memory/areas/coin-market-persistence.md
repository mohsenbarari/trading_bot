...
- Stage 12 parity is redacted/HMAC-signed and classifies capture/parser/lifecycle/unit/timing/transport/estimator drift. Live comparison fans out after one Telegram capture owner; parser drift needs approved labels and offline replay cannot replace the open-market gate.
