...
- Missing, stale, future, malformed, or unsupported evidence fails open. While this guard is active it bypasses legacy mean/0.4% rejection; staging defaults on and production defaults off.
