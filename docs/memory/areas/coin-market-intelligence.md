...
- Private melted offer: immutable price/quantity, 120s lifetime. New/lower explicit remaining gives cumulative fill; zero=full, positive closure=no-trade. Generic edit≠trade; inconsistency=ambiguous; partials finalize at deadline. Estimator freshness=900s.
