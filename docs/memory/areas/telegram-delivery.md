...
- 2026-08-23 | Split: `primary` polls/ACKs; sole `executor` owns queues, OTP and global lock. Leases fail closed; cutover postchecks and preserves jobs on rollback. Readbacks activate both profiles. APIs only produce.
