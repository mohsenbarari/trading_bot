...
- thirteen production negative-guard probes on Iran/WebApp:
...
`173` command-plannable scenarios with these drivers:
...
- `13` negative business-guard scenarios with explicit no-partial-mutation
  assertions.
