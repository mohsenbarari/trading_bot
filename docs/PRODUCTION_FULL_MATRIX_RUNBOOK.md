...
- implemented: twelve Iran/WebApp negative-guard probes:
...
- current whole-manifest command-plannable count: `172` of `5555` scenarios;
...
1. `negative_guard_driver`: `587` gaps. Add explicit production reject-path
