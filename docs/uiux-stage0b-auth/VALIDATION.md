...
- ۱۱ قاب موبایل با اندازه دقیق `390 × 844` تولید شد و هیچ محتوای screen به‌صورت عمودی clip نشد.
- هیچ قاب در عرض‌های `360`، `375`، `390`، `414` و `430` پیکسل horizontal overflow نداشت.
- ۳۲ هدف لمسی علامت‌گذاری‌شده بررسی شد؛ کمینه اندازه `84 × 44` پیکسل و تعداد اهداف زیر ۴۴ پیکسل صفر بود.
