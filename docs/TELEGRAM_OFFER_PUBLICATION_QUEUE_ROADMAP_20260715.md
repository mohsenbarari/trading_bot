...
- اتصال عملیات زمان‌دار به main و حذف sleep-taskهای حافظه‌ای برای cleanupهای تحت قرارداد؛ feeder اعلان وضعیت بازار در برش `2026-07-18` متصل شد
