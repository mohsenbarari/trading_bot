...
3. **foundation pure و persistence/feedback انجام شد:** گام بعد adapter runtime و cutover خانواده‌ای پیام‌های خصوصی بر اساس صف تابع مصوب است. تبدیل مکانیکی `message.answer` بدون receipt بادوام، source identity و dependency resolution همچنان ممنوع است.
