...
| `legacy_mode_guarded` | `62` | شاخه queue پیش از فراخوانی مستقیم خارج می‌شود؛ شامل adapter مشترک callback |
...
| `remaining_callback_direct` | `118` | blocker Stage 3؛ فقط `callback/query.answer` واقعی |
