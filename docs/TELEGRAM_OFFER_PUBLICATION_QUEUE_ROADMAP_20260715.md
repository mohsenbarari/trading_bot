...
- وضعیت Roadmap: تصمیم‌های محصول و معماری این گفتگو ثبت شده‌اند؛ سناریوی دقیق آزمایش staging گام بعدی است.
...
سناریوی اجرایی دقیق در گام بعدی در سند زیر ثبت خواهد شد:
...
- نرخ ثابت `3 offer/s`
- اجرای طولانی حداقل `30` دقیقه برای گزینه منتخب
- burst کوتاه `6 offer/s`
- ری‌استارت worker در حین backlog
- `429`، `5xx`، قطع شبکه، timeout و `403`
- همه کالاهای فعال، خرید/فروش، تمام انواع تسویه، عمده/خرد، لات‌ها، توضیحات و هشدار قیمت
- fixtureهای تصادفی production فقط با دسترسی read-only
