...
3. **foundation pure انجام شد:** persistence/feedback قرارداد نتیجه/anchor و سپس cutover پیام‌های خصوصی بر اساس صف تابع مصوب. تبدیل مکانیکی `message.answer` بدون receipt بادوام و dependency resolution همچنان ممنوع است.
