...
وضعیت: مورد تأیید مالک محصول؛ Stage 0A تکمیل و «مالی مدرن» انتخاب شد؛ مالک محصول ادامه به Stage 0B-2 را مجاز و گیت چهار‌دستیار را فعلاً تعلیق کرده است؛ 0B-2 design-only و در حال اجراست
