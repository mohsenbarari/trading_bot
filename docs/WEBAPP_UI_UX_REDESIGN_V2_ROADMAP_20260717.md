...
وضعیت: مورد تأیید مالک محصول؛ Stage 0A تکمیل و «مالی مدرن» انتخاب شد؛ اصلاح خلوتی هدفمند در Stage 0B-1 اعمال شده و در انتظار review gate چهار‌نقشی exact-SHA است
