...
وضعیت: مورد تأیید مالک محصول؛ Stage 0A تکمیل و «مالی مدرن» انتخاب شد؛ مالک محصول ادامه به Stage 0B-2 را مجاز و گیت چهار‌دستیار را فعلاً تعلیق کرده است؛ 0B-2 از نظر فنی تکمیل و در انتظار تصمیم صریح مالک محصول برای عبور به 0B-3 است
