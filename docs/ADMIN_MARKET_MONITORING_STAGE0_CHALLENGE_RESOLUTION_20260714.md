...
- نتیجه: `AMM-C03` در وضعیت `DECIDED` قرار گرفت و challenge بعدی `AMM-C04` است.
...
`AMM-C03` نهایی شده است. challenge بعدی `AMM-C04` خواهد بود: ماتریس مجوز مدیر میانی و مدیر ارشد برای مشاهده و اقدام.
