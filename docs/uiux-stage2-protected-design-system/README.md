...
Stage 2 با مجوز پیشروی پیوسته مالک `complete` و Stage 3 `authorized_not_started` است. implementation/evidence commit واقعی شاخه محصول `7d1833f33d3332d574ceae312cfc624daaf4f1e5` است؛ governance transaction این binding را ثبت و سپس شاخه را push می‌کند. runtime Stage 3 هنوز شروع نشده است.
