...
وضعیت: مالک محصول 0B-1 تا 0B-5 را تکمیل و تأیید کرده است؛ `0B-6` فقط در سطح قرارداد طراحی در حال انجام، گیت چهار‌دستیار فعلاً تعلیق و runtime همچنان ممنوع است
...
وضعیت: **در حال انجام فقط در سطح قرارداد طراحی و پذیرش.** شروع runtime تا تأیید صریح خروجی نهایی همین checkpoint ممنوع است.
...
گام جاری **`0B-6` — قرارداد نهایی سیستم و پذیرش** است و فقط در سطح طراحی انجام می‌شود. `0B-5` با تأیید صریح بصری مالک در ۲۰۲۶-۰۸-۰۸ بسته شده است؛ شروع پیاده‌سازی فقط پس از تکمیل و تأیید صریح خروجی نهایی `0B-6` ممکن است.
