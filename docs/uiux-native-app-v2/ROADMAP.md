...
- این track به‌تنهایی مجوز Figma، Sites یا استقرار نیست؛ ادغام و انتشار فقط پس از گیت مستقل انجام می‌شود
...
وضعیت زیر پس از ممیزی مستقل ناظر در ۲۰۲۶-۰۸-۲۸ است. نام‌های تاریخی
`ui-v2-*` که فقط نقش hook سازگاری دارند به‌تنهایی یک زبان بصری دوم نیستند؛ حذف آن‌ها بدون
تغییر تجربه، معیار پایان track نیست. Market و interiorهای صریحاً منجمد نیز در شمار مسیرهای
این track قرار نمی‌گیرند.

| فاز | وضعیت |
|---|---|
| ۰ قرارداد و ممیزی | complete |
| ۱ foundation | complete — primitiveها، فاصله، عرض خواندن و هدف لمسی قرارداد مشترک دارند؛ hookهای سازگاری حفظ شده‌اند |
| ۲ پوسته | complete — یک `main` و یک `h1`، ناوبری و سطح مسیر روی ۲۹ مسیر غیر Market برقرار است |
| ۳ خانه | complete-in-scope — chrome غیر Market هم‌زبان است و ویجت Market بایت‌به‌بایت منجمد ماند |
| ۴ حساب | complete — هاب و زیرصفحه‌های حساب/تنظیمات/اعلان grouped، کوتاه و هم‌زبان‌اند |
| ۵ پروفایل | complete — هویت و گروه‌ها یکپارچه‌اند؛ تلفن و نشانی طبق قرارداد پروژه برای کاربر دیگر نیز مرئی‌اند |
| ۶ عملیات | complete — فهرست، جزئیات، اقدام‌ها و overlayهای زنده قرارداد inset مشترک دارند |
| ۷ مدیریت | complete-in-scope — مدیریت غیر Market و CreateChannel هم‌زبان‌اند؛ interiorهای منجمد دست‌نخورده‌اند |
| ۸ احراز | complete — مسیرهای ورود، ثبت‌نام، دعوت و بازیابی در حالت‌ها و صفحه‌کلید پوشش دارند |
| ۹ پیام‌رسان | complete-in-scope — ظاهر immersive و overlayها یکپارچه‌اند؛ رفتار، آلبوم و rollout قفل ماند |
| ۱۰ overlay | complete — موجودی زنده، نام در دسترس، trap فوکوس، Escape و بازگشت فوکوس سبز است |
| ۱۱ پذیرش | complete — گیت‌های واحد، typecheck، build، guard و ماتریس چندمرورگر اجرا شد؛ حکم نهایی در `SUPERVISOR_HANDOFF.md` است |
