...
| پوسته پروفایل عمومی | بازگشت، بازیابی خطا و ویرایش آدرس بدون شکستن ظاهر مشترک | نگه‌داری، visual-unification | بازگشت و ویرایش آدرس `ui-icon-button` هستند؛ تلاش دوباره `ui-button` است؛ privacy/authority عوض نشده است. |
| انتخاب تاریخ سفارشی مدیریت | تعیین پایان محدودیت یا مسدودیت بدون شکستن ظاهر مشترک | نگه‌داری، visual-unification | ماشهٔ تاریخ `ui-button` است؛ منطق Jalali و mutation عوض نشده است. |
| آواتار و لینک پروفایل عمومی | تغییر آواتار خود و باز کردن پروفایل طرف معامله بدون شکستن ظاهر مشترک | نگه‌داری، visual-unification | آواتار specialized می‌ماند؛ لینک `--ds-success-700` است؛ آپلود confirm نشده و navigation فقط ID است. |
| کارت اقدام پروفایل عمومی | رسیدن به تنظیمات، مشتریان و حسابداران بدون شکستن ظاهر مشترک | نگه‌داری، visual-unification | کارت `ui-action-card` با رنگ `--ds-*` است؛ navigation تنظیمات عوض نشده است. |
