...
The project logs to stdout so Docker can collect and rotate logs. JSON output is
used by default in production-like environments to make logs searchable across
Iran/foreign deployments.
"""
...
class JsonLogFormatter(logging.Formatter):
    """Small dependency-free JSON formatter for Python logging."""
