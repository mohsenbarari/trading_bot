...
_SYNC_REGISTRY: dict[str, SyncRegistryEntry] = {
    ...
    "session_login_requests": _entry(
        ...
        SyncPolicy.NO_SYNC,
        ("webapp_auth_runtime",),
        "private WebApp FI/IR replica authority",
        "single Witness-leased Writer; ordered private projection to the standby",
        "WebApp login flow continuity only; never project to Bot-FI",
    ),
    "single_session_recovery_admin_targets": _entry(
        ...
        "private WebApp FI/IR replica authority",
        "single Witness-leased Writer; ordered private projection to the standby",
        "WebApp recovery continuity only; never project to Bot-FI",
    ),
    ...
    "user_sessions": _entry(
        ...
        "private WebApp FI/IR replica authority",
        "single Witness-leased Writer; ordered private projection to the standby",
        "WebApp session continuity only; never project to Bot-FI",
    ),
    "users": _entry(
        "users",
        SyncPolicy.SYNC,
