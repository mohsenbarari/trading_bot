...
_SYNC_REGISTRY: dict[str, SyncRegistryEntry] = {
    ...
    "coin_intelligence_shadow_feature_snapshots": _entry(
    ...
    "coin_intelligence_shadow_outcomes": _entry(
        ...
        SyncPolicy.INTERNAL_BOOKKEEPING,
        ("coin_intelligence_shadow", "operator_review"),
        "local physical site",
        "append-only versioned outcome evidence; never cross-site business sync",
        "non-authoritative model scoring only",
    ),
    "coin_intelligence_shadow_parser_results": _entry(
        "coin_intelligence_shadow_parser_results",
        SyncPolicy.INTERNAL_BOOKKEEPING,
        ("coin_intelligence_shadow",),
        "local physical site",
        "one immutable parser comparison per run",
        "non-authoritative parser evaluation only",
    ),
    "coin_intelligence_shadow_predictions": _entry(
    ...
    "coin_intelligence_shadow_runs": _entry(
        ...
        ("coin_intelligence_shadow",),
        "local physical site",
        "idempotency key; local run identity is never merged",
        "non-authoritative model execution audit only",
    ),
    "chat_files": _entry(
        "chat_files",
        SyncPolicy.NO_SYNC,
