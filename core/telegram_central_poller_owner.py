...
def _application_engine() -> AsyncEngine:
    # Keep lock constants and deployment probes importable before runtime
    # settings are loaded. Runtime acquisition still resolves the canonical
    # application engine on demand.
