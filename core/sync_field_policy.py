...
_FIELD_POLICIES: dict[tuple[str, str], SyncFieldPolicyEntry] = {
    ...
    ("telegram_admin_broadcasts", "content_kind"): _entry(
        "telegram_admin_broadcasts",
        "content_kind",
        SyncFieldClassification.SYNC,
        reason="Telegram admin broadcast payload kind for text or video",
    ),
    ("telegram_admin_broadcasts", "telegram_media_file_id"): _entry(
        "telegram_admin_broadcasts",
        "telegram_media_file_id",
        SyncFieldClassification.SYNC,
        sensitive=True,
        reason="bot-scoped Telegram file_id for admin video broadcast",
    ),
    ("telegram_admin_broadcasts", "telegram_media_file_unique_id"): _entry(
        "telegram_admin_broadcasts",
        "telegram_media_file_unique_id",
        SyncFieldClassification.SYNC,
        sensitive=True,
        reason="Telegram file_unique_id for admin video broadcast",
    ),
    ("telegram_admin_broadcasts", "media_duration_seconds"): _entry(
        "telegram_admin_broadcasts",
        "media_duration_seconds",
        SyncFieldClassification.SYNC,
        reason="optional Telegram video duration metadata",
    ),
    ("telegram_admin_broadcasts", "media_width"): _entry(
        "telegram_admin_broadcasts",
        "media_width",
        SyncFieldClassification.SYNC,
        reason="optional Telegram video width metadata",
    ),
    ("telegram_admin_broadcasts", "media_height"): _entry(
        "telegram_admin_broadcasts",
        "media_height",
        SyncFieldClassification.SYNC,
        reason="optional Telegram video height metadata",
    ),
    ("telegram_admin_broadcasts", "media_file_size"): _entry(
        "telegram_admin_broadcasts",
        "media_file_size",
        SyncFieldClassification.SYNC,
