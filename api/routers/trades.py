...
# Keep this single-key PostgreSQL advisory lock distinct from other one-key
# runtime locks such as the mandatory-channel housekeeping lock.
TRADE_NUMBER_ALLOCATION_LOCK_ID = 362_514_101
